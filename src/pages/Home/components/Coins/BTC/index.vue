...
// 计算生成 Legacy 地址
function generateLegacyAddress(root: BIP32Interface): DataItem {
...
function generateNestedSegwitAddress(root: BIP32Interface): DataItem {
...
function generateNativeSegwitAddress(root: BIP32Interface): DataItem {
...
// 计算生成 Taproot 地址
function generateTaprootAddress(root: BIP32Interface): DataItem {
